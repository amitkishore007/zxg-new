...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Zedexgoldcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"zedexgoldcointools.com", "159.65.156.152"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"zedexgoldcointools.com", "testnet-seed.zedexgoldcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Zedexgoldcoin is probably already running."), addrBind.ToString().c_str());
        else
